...
let h2Elem = document.createElement('otsikko');
...
let headerElem1 = document.createElement('header1');
articleElem.appendChild(headerElem1);

let h2Elem1 = document.createElement('tokaotsikko');
headerElem1.appendChild(h2Elem1);
h2Elem1.innerText = 'Lisää hassunhauskaa faktaa';

let pElem1 = document.createElement('p1');
