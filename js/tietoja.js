...
h2Elem.innerText = "Yleistä tietoa Helsingin koirapuistoista";
...
let articleElem1 = document.createElement("article");
sectionElem.appendChild(articleElem1);

let h2Elem1 = document.createElement("h2");
articleElem1.appendChild(h2Elem1);
h2Elem1.innerText = "Lisää tarkempia tietoja";

let pElem1 = document.createElement("p");
articleElem1.appendChild(pElem1);
